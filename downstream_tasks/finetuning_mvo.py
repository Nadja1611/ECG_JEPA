...
def main(config):
   ...
   # waves_train, waves_test, labels_train, labels_test = waves_from_config(config)
    waves_train = torch.load('/gpfs/data/fs72515/nadja_g/ECG_JEPA_Git/ECG_JEPA/downstream_tasks/ecgs_train.pt')
    waves_test = torch.load('/gpfs/data/fs72515/nadja_g/ECG_JEPA_Git/ECG_JEPA/downstream_tasks/ecgs_val.pt')
    labels_train = torch.load('/gpfs/data/fs72515/nadja_g/ECG_JEPA_Git/ECG_JEPA/downstream_tasks/mvo_bin_train.pt')
    labels_test = torch.load('/gpfs/data/fs72515/nadja_g/ECG_JEPA_Git/ECG_JEPA/downstream_tasks/mvo_bin_val.pt')
